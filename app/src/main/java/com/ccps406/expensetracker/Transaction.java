    ...
    public void addTo(String type) throws ParseException {
        ...
        if(!isRecurring){
            ...
            if(isEndByOccurrences) {
                ...
                if (Integer.parseInt(occurrencesStr) <= 0){mOccurrences.setError("Enter Number > 0");}
                ...
                if(startDate.equals(ttDate)){ addToHistory(rByOccurrence,docId);
                    addToUpcoming(rByOccurrence,docId);}
            }
            else{
